    ...
    <div className="bg-gray-200 py-5 px-5 md:px-12 lg:px-28 ">
        <div className="flex justify-between items-center">
          ...
          {/* Go to home page  */}
            ...
            <Link href='/admin'>
              <button className="flex cursor-pointer items-center gap-2 font-medium py-1 px-3 sm:py-3 sm:px-6 border border-black shadow-[-7px_7px_0px_#000000] ">
        ...
        <div className="text-center my-24 ">
            ...
            <Image className="mx-auto mt-6 border border-white rounded-full " src={data.authorImg} width={60} height={60} alt="Author's Image" />
