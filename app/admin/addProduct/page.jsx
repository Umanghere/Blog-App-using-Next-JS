  ...
  return (
    <>
      <form onSubmit={onSubmitHandle} className="pt-5 px-5 sm:pt-12 sm:pl-16">
        ...
        <textarea  name='description' onChange={onChangeHandler} value={data.description} className='w-full sm:w-[500px] mt-4 px-4 py-3 border' type="textarea" rows={8} placeholder='Write content here' required />
